...
import { Settings, LogIn, LogOut, LineChart, Package, ShoppingBag, Plus, Trash2, Edit, Save, CheckCircle, FileText, Bot, Send, ArrowRight, Printer, AlertTriangle, X, Sparkles, Users, Award, Eye, Search } from 'lucide-react';
      ...
      <div className="max-w-md mx-auto py-6 px-4 animate-in zoom-in duration-150" id="admin-login-screen">
        <div className="bg-white border border-zinc-200 p-6 rounded space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider">Restricted secure authentication. Authenticate to manage the console.</p>
          </div>
          ...
          {authLoading ? (
            ...
            <div className="space-y-5">
              ...
              <button
                ...
                className="w-full py-2.5 px-4 bg-zinc-50 hover:bg-zinc-100 border border-zinc-200 hover:border-zinc-300 text-zinc-800 font-bold rounded text-xs uppercase tracking-wider flex items-center justify-center gap-2.5 transition-all shadow-xs cursor-pointer"
              ...
              <div className="relative flex py-1 items-center">
                ...
                <span className="flex-shrink mx-3 text-[8px] font-bold text-zinc-400 uppercase tracking-widest">OR Password login</span>
                <div className="flex-grow border-t border-zinc-200"></div>
              </div>
    ...
    <div className="space-y-8 pb-16 animate-in fade-in duration-150" id="admin-root-dashboard">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-zinc-200 pb-5">
        <div className="flex flex-row justify-between items-center w-full md:w-auto">
          ...
          {currentUser && (
            <button
              ...
              className="md:hidden px-2.5 py-1.5 border border-zinc-200 hover:bg-zinc-50 text-zinc-700 hover:text-black font-bold rounded text-[9px] uppercase tracking-wider transition-all flex items-center gap-1.5 shrink-0"
              title="Logout"
            >
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto justify-between md:justify-end">
          {currentUser && (
            <div className="hidden md:flex items-center gap-2 px-3 py-1 bg-zinc-50 border border-zinc-200 rounded">
              <span className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse"></span>
              <span className="text-[9px] font-bold text-zinc-500 uppercase tracking-wider">{currentUser.email}</span>
            </div>
          )}
          ...
          {currentUser && (
            <button
              onClick={handleSignOut}
              className="hidden md:flex px-3 py-1.5 border border-zinc-200 hover:bg-zinc-50 text-zinc-700 hover:text-black font-bold rounded text-[10px] uppercase tracking-wider transition-all items-center gap-1.5 shrink-0 cursor-pointer"
            >
